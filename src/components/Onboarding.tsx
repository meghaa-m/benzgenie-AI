      ...
      <AnimatePresence mode="wait">
        {slide < slides.length ? (
          <motion.div
            ...
            className="w-full max-w-lg glass-panel p-8 rounded-2xl relative border border-slate-800/80 shadow-2xl flex flex-col items-center text-center"
          >
            <div className="mb-6 p-4 rounded-full bg-slate-900/80 border border-slate-800 pulse-genie">
              {slides[slide].icon}
            </div>

            <span className="text-xs font-mono tracking-widest text-violet-400 uppercase mb-2">
              Step {slide + 1} of 4
            </span>
            ...
            <button
              ...
              onClick={handleNext}
              className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white font-medium py-3 px-6 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2"
            >
              Continue
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            transition={{ duration: 0.4 }}
            className="w-full max-w-lg glass-panel p-8 rounded-2xl relative border border-slate-800/80 shadow-2xl"
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-display font-bold text-white">Setup Your Console</h1>
                <p className="text-xs text-slate-400">Customize BizGenie for your business sector</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-slate-800 rounded-xl py-3 px-4 text-white text-sm focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition-all"
            ...
            <button
              ...
              onClick={handleNext}
              className="w-full bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:from-violet-500 hover:to-fuchsia-500 text-white font-semibold py-3.5 px-6 rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 text-sm uppercase tracking-wider"
            >
              Enter BizGenie Console
